...
import com.example.sparta.hanghaefinal.domain.response.MultipleResult;
import com.example.sparta.hanghaefinal.domain.response.Result;
import com.example.sparta.hanghaefinal.domain.response.SingleResult;
